...
trait Base extends Selectors {
  ...
  def bisect[T](arr: js.Array[T], x: T, low: Double = ???, high: Double = ???): Double = js.native

  def bisectLeft[T](arr: js.Array[T], x: T, low: Double = ???, high: Double = ???): Double = js.native

  def bisectRight[T](arr: js.Array[T], x: T, low: Double = ???, high: Double = ???): Double = js.native
  ...
  def formatPrefix(value: Double, precision: Double = ???): MetricPrefix = js.native
...
trait Xhr extends js.Object {
  ...
  def get(): Xhr = js.native

  def post(): Xhr = js.native

  def get(callback: js.Function1[XMLHttpRequest, Unit]): Xhr = js.native
...
trait Dsv extends js.Object {
  def apply(url: String, callback: js.Function2[js.Any, js.Array[js.Any], Unit] = ???): Xhr = js.native
...
trait Selection extends Selectors {
  ...
  def style(name: String, valueFunction: js.Function2[js.Any, Double, Any]): Selection = js.native
  ...
  def data(values: js.Function2[js.Any, Double, js.Array[js.Any]], key: js.Function2[js.Any, Double, Any] = ???): UpdateSelection = js.native
  ...
  def filter(filter: js.Function2[js.Any, Double, Boolean], thisArg: js.Any = ???): UpdateSelection = js.native
  ...
  def on(`type`: String, listener: js.Function2[js.Any, Double, Any], capture: Boolean = ???): Selection = js.native
...
trait Transition extends js.Object {
  ...
  def style(name: String, valueFunction: js.Function2[js.Any, Double, Any]): Transition = js.native
  ...
  def styleTween(name: String, tween: js.Function3[js.Any, Double, js.Any, BaseInterpolate], priority: String = ???): Transition = js.native
...
trait InterpolateFactory extends js.Object {
  def apply(a: js.Any = ???, b: js.Any = ???): BaseInterpolate = js.native
}

trait BaseInterpolate extends js.Object {
  def apply(a: js.Any, b: js.Any = ???): js.Dynamic = js.native
}
...
trait StackLayout extends js.Object {
  def apply[T](layers: js.Array[T], index: Double = ???): js.Array[T] = js.native

  def values(accessor: js.Function1[js.Any, Any] = ???): StackLayout = js.native
...
trait PieLayout extends js.Object {
  def apply(values: js.Array[js.Any], index: Double = ???): js.Array[ArcDescriptor] = js.native
...
trait HistogramLayout extends js.Object {
  def apply(values: js.Array[js.Any], index: Double = ???): js.Array[Bin] = js.native
...
trait Brush extends js.Object {
  ...
  def on(`type`: String, listener: js.Function2[js.Any, Double, Any], capture: Boolean = ???): Brush = js.native
}
...
trait Axis extends js.Object {
  ...
  def nice(count: Double = ???): Axis = js.native
}

trait Arc extends js.Object {
  def apply(data: js.Any, index: Double = ???): String = js.native
  ...
  def centroid(data: js.Any, index: Double = ???): js.Array[Double] = js.native
}

trait Line extends js.Object {
  def apply(data: js.Array[js.Any], index: Double = ???): String = js.native
...
trait GenericQuantitativeScale[S] extends GenericScale[S] {
  ...
  def interpolate(factory: D3.Transition.Interpolate): S = js.native

  def clamp(): Boolean = js.native

  def clamp(clamp: Boolean): S = js.native

  def nice(count: Double = ???): S = js.native
...
trait OrdinalScale extends GenericScale[OrdinalScale] {
  def rangePoints(interval: js.Array[js.Any], padding: Double = ???): OrdinalScale = js.native

  def rangeBands(interval: js.Array[js.Any], padding: Double = ???, outerPadding: Double = ???): OrdinalScale = js.native

  def rangeRoundBands(interval: js.Array[js.Any], padding: Double = ???, outerPadding: Double = ???): OrdinalScale = js.native
...
trait TimeScale extends GenericScale[TimeScale] {
  ...
  def nice(count: Double = ???): TimeScale = js.native
}
...
trait Path extends js.Object {
  def apply(feature: js.Any, index: js.Any = ???): String = js.native
...
trait Projection extends js.Object {
  ...
  def stream(listener: Stream = ???): Stream = js.native
}
...
trait Geom extends js.Object {
  ...
  def delaunay(vertices: js.Array[Vertice] = ???): js.Array[Polygon] = js.native
